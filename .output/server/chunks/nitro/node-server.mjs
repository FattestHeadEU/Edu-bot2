...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"C:\\Users\\derby\\coding workspace\\Edu Bot\\Nitro\\nitro-app\\.data\\kv"}));
...
const _lazy_OsCwi3 = () => import('../index.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/', handler: _lazy_OsCwi3, lazy: true, middleware: false, method: undefined }
];
...
export { eventHandler as e, nodeServer as n };
